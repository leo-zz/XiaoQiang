...
var swapSpaceRatio = [];
var physicalMemory = requesthostMem()[0];
var swapSpace = requesthostMem()[1];
//JVM内存情况
var heapUsedMemory = [];
...
var totalLoadedClassCount = requesttotalLoadedandUnloadedClassInfo()[0];
var unloadedClassCount = requesttotalLoadedandUnloadedClassInfo()[1];
var bootClassPath = requesttotalLoadedandUnloadedClassInfo()[2];
var classPath = requesttotalLoadedandUnloadedClassInfo()[3];
//线程信息
var threadCount = [];
var deadlockedThreadsNum = [];
var monitorDeadlockedThreadsNum = [];
var peakThreadCount = requestPeakandtotalStartedThreadInfo()[0];
var totalStartedThreadCount = requestPeakandtotalStartedThreadInfo()[1];
// 指定图表的配置项和数据
cpuOption = {
    title: {
        text: 'CPU使用率%',
...
classOption = {
    title: {
        text: 'jvm类信息',
        subtext: '类加载总数量：' + totalLoadedClassCount + ',类卸载数量:' + unloadedClassCount + ',bootstrap类加载路径:' + bootClassPath + ',其他类加载路径:' + classPath
    },
    //提示内容,参考配置项文档http://www.echartsjs.com/option.html#title
    tooltip: {
        trigger: 'axis',
